...
public abstract class GlBaseView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	 ...
	 */
	public GlBaseView(Context c, int fps) {
		super(c);
		sHolder = getHolder();
