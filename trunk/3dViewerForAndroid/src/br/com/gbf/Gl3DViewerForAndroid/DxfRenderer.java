...
public class DxfRenderer {
    ...
    ArrayList<DxfLayer> mLayers; 
    ArrayList<DxfEntity> mEntities;
	...
	public DxfRenderer() {
		mLoaded = false;
		mEntities = new ArrayList<DxfEntity>();
		mLayers = new ArrayList<DxfLayer>();
		mFacesVertex = new ArrayList<Float>();
		mColorsVertex = new ArrayList<Float>();
		mNormalsVertex = new ArrayList<Float>();
		mLinesVertex = new ArrayList<Float>();
		mLineNumber = 0;
	}
